      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <ul class="dropdown-menu dropdown-menu-start dropdown-menu-dark">
            <li
              v-for="(item, index) in sortTypeOptions"
              :key="index"
            >
              <a
                class="dropdown-item"
              ...
              <div class="market__content__top d-flex align-items-center">
                ...
                <div class="ms-auto">
                  <div class="d-flex align-items-center">
                    <span
                      class="el__order__label me-3 d-none d-xl-block"
                    >Sort by:</span>
                    <div class="btn-group">
                      <button
...
export default {
  ...
  methods: {
    ...
    getSortTypeSelected () {
      const sortType = this.sortTypeOptions.find(item => item.value === this.sortType)
